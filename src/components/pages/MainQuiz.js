        ...
        this.setState(allSyndrome, () => {
            ...
            if (this.props.sibling === 'yes') {
                ...
                const brothers = {
                    ...
                    brother_milk_intolerance: this.state
                        .brother_milk_intolerance,
                    brother_rhinitis: this.state.brother_rhinitis,
                    brother_atopic_dermatitis: this.state
                        .brother_atopic_dermatitis,
        ...
        if (this.props.sibling === 'no' || this.props.sibling === '0') {
            this.setState(
                ...
                () => {
                    ...
                    this.props.mainQuizAction(
                        this.state,
                        this.props.children_id
                    );
                    ...
                    <li className="quiz__item">
                        <label className="quiz__trigger" title="ไม่แน่ใจ">
                            <input
                                ...
                                onChange={this.handleChange}
                                checked={
                                    this.state[`${stateTitle}`] === 'not-sure'
                                }
                            />
                        ...
                        <div className="people">
                            ...
                            {this.props.sibling === 'yes' ? (
                                <a
                                    ...
                                    onClick={this.changeMember.bind(
                                        this,
                                        'brother'
                                    )}
                                >
